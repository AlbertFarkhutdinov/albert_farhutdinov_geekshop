...
class ProductsTestCase(TestCase):
    def setUp(self):
        ...
        self.product_1 = Product.objects.create(name="Chair 1", category=category, price=1999.5, quantity=150)
        self.product_2 = Product.objects.create(name="Chair 2", category=category, price=2998.1, quantity=125,
                                                is_active=False)
        self.product_3 = Product.objects.create(name="Chair 3", category=category, price=998.1, quantity=115)
