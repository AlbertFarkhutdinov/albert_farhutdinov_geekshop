...
class ProductCategory(models.Model):
    ...
    is_active = models.BooleanField(db_index=True, verbose_name="Is Active?", default=True)
...
class Product(models.Model):
    ...
    is_hot = models.BooleanField(verbose_name="Is hot?", default=False)
    is_featured = models.BooleanField(verbose_name="Is featured?", default=False)
    is_new = models.BooleanField(verbose_name="Is new?", default=False)
    is_active = models.BooleanField(db_index=True, verbose_name="Is active?", default=True)
